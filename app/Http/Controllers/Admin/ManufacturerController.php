...
class ManufacturerController extends Controller implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            'auth',
            new Middleware('permission:manufacturer.view', only: ['index', 'getdata']),
            new Middleware('permission:manufacturer.create', only: ['store']),
            new Middleware('permission:manufacturer.edit', only: ['update', 'statusUpdate']),
            new Middleware('permission:manufacturer.delete', only: ['distroy']),
        ];
    }

    public function statusUpdate(Request $request, $id)
    {
        $find = Manufacturer::find($id);
    ...
    {
        if ($request->ajax()) {
            $data = Manufacturer::orderBy('created_at', 'desc')->get();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $deleteUrl = route('manufacturer.distroy', $row->id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json(['success' => true, 'message' => 'Manufacturer Created Successfully!']);
        } catch (\Exception $e) {
            DB::rollBack();
            return response()->json([
                'success' => false,
    ...
    public function edit($id)
    {
        ...
        return view('backend.manufacturer.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return response()->json(['success' => true, 'message' => 'Manufacturer Updated Successfully!']);
        } catch (\Exception $e) {
            DB::rollBack();
            return response()->json([
                'success' => false,
    ...
    public function distroy($id)
    {
        ...
        if (!$find) {
            Alert::error('Error', 'Manufacturer not found!');
        ...
        Alert::success('Success', 'Manufacturer deleted Successful!');
        return redirect()->route('manufacturer.index');
    }
}
