...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
        <form id="brandEditModalForm" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="name" maxlength="100"
                            placeholder="Enter brand name" value="{{ $data->name }}"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @if ($data->image)
                            <div class="mt-2">
                                <img src="{{ asset('brands/image/' . $data->image) }}" width="90" height="90"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="description" rows="4" placeholder="Enter brand description"
            ...
            <input type="hidden" value="{{ $data->id }}" id="brand_id">
        </form>
    </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="brandEditModalForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#brandEditModalForm").on("submit", function(e) {
            e.preventDefault();
            showLoading();
            ...
            $.ajax({
                url: "{{ route('brand.update', ':id') }}".replace(':id', brandId),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    hideLoading();
                    if (response.success) {
                        $("#brandEditModalForm")[0].reset();
                        $("#brandEditModal").modal("hide");
                        window.location.href =
                            "{{ route('brand.index') }}?added-successfully=" +
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Not Found',
                            text: xhr.responseJSON?.message || 'Brand not found!',
                            confirmButtonColor: '#FF4C29'
                        });
                    } else {
                        Swal.fire({
