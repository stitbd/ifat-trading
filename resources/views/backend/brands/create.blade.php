    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
            ...
            <div class="modal-header align-items-start"
                ...
                <div>
                    <h5 class="modal-title mb-1" style="color:#1e1e2d; font-weight:700; font-size:18px;">
                        <i class="bi bi-award-fill me-2" style="color:#4361ee;"></i>
                        Create Brand
                    </h5>
            ...
            <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
                <form id="brandCreateModalForm" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer d-flex justify-content-between align-items-center"
                ...
                <div>
                    ...
                    <button type="submit" form="brandCreateModalForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#brandCreateModalForm").on("submit", function(e) {
            e.preventDefault();
            showLoading();
