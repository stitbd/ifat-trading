    ...
    <div class="app-container container-fluid">
        <div class="admin-page-header">
            <div class="admin-page-header-title">
                <span class="icon-box"><i class="bi bi-building-gear"></i></span>
                <h1>Warehouse</h1>
            </div>
            <button data-bs-toggle="modal" data-bs-target="#warehouseCreateModal" class="btn-admin-primary">
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="admin-card">
            <div class="admin-card-header">
                <h5><i class="bi bi-table" style="color:#4361ee;"></i> Warehouse List</h5>
                <div id="warehouseTableButtons"></div>
            </div>

            <table id="warehouseTable" class="display admin-table" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
...
<div class="modal fade" id="warehouseEditModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content admin-modal-content" id="modalShow"></div>
    </div>
</div>

@include('backend.warehouse.create')
...
<script>
    $(document).ready(function() {
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    customize: function(doc) {
                        doc.content[1].table.widths = ['8%', '22%', '25%', '25%', '20%'];
        ...
        table.buttons().container().appendTo('#warehouseTableButtons');
    });

    $(document).on('click', '.edit', function() {
        var dataId = $(this).data('id');
        $.ajax({
            url: '/warehouse/edit/' + dataId,
            type: 'GET',
