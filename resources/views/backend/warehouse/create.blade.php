    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
            ...
            <div class="modal-header align-items-start"
                ...
                <div>
                    <h5 class="modal-title mb-1" style="color:#1e1e2d; font-weight:700; font-size:18px;">
                        <i class="bi bi-building-add me-2" style="color:#4361ee;"></i>
                        Create Warehouse
                    </h5>
            ...
            <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
                <form id="warehouseCreateForm" method="POST">
                    @csrf
                    ...
                    <div class="p-4 mb-3" style="background:#fff; border:1px solid #eef0f2; border-radius:10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" name="address" rows="3" placeholder="Enter Warehouse Address"
            ...
            <div class="modal-footer d-flex justify-content-between align-items-center"
                ...
                <div>
                    ...
                    <button type="submit" form="warehouseCreateForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#warehouseCreateForm").on("submit", function(e) {
            showLoading();
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        $("#warehouseCreateForm")[0].reset();
                        $("#warehouseCreateModal").modal("hide");
                        hideLoading();
