<div class="modal fade" id="warrantyPeriodCreateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
            ...
            <div class="modal-header align-items-start"
                ...
                <div>
                    <h5 class="modal-title mb-1" style="color:#1e1e2d; font-weight:700; font-size:18px;">
                        <i class="bi bi-shield-check me-2" style="color:#4361ee;"></i>
                        Create Warranty Period
                    </h5>
                    <p class="mb-0" style="color:#8a8a9a; font-size:13px;">
                        Add a new warranty period to your catalog
                    </p>
                </div>
            ...
            <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
                <form id="warrantyPeriodCreateForm" method="POST">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="title"
                                    placeholder="Enter title (e.g. 6 Months Warranty)"
            ...
            <div class="modal-footer d-flex justify-content-between align-items-center"
                ...
                <div>
                    ...
                    <button type="submit" form="warrantyPeriodCreateForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#warrantyPeriodCreateForm").on("submit", function(e) {
            showLoading();
            e.preventDefault();
            let formData = new FormData(this);
            $.ajax({
                url: "{{ route('warranty-period.store') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    if (response.success) {
                        $("#warrantyPeriodCreateForm")[0].reset();
                        $("#warrantyPeriodCreateModal").modal("hide");
                        hideLoading();
