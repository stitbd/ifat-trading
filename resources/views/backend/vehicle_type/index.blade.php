...
@include('backend.vehicle_type.create')
...
<script>
    ...
    $(document).on('click', '.edit', function() {
        ...
        $.ajax({
            url: '/vehicle-type/edit/' + dataId,
            type: 'GET',
            success: function(response) {
                $('#modalShow').html(response);
                $('#vehicleTypeEditModal').modal('show');
            }
        });
    });
...
<script>
    $(document).on('click', '.status-toggle', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    $('#vehicleTypeTable').DataTable().ajax.reload(null, false);
