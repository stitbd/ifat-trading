...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-header align-items-start"
        ...
        <div>
            <h5 class="modal-title mb-1" id="vehicleTypeEditModalLabel"
    ...
    <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
        <form id="vehicleTypeEditForm" method="POST">
            @csrf
            @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter vehicle type name" value="{{ $data->name }}"
            ...
            <input type="hidden" value="{{ $data->id }}" id="vehicle_type_id">
        </form>
    </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="vehicleTypeEditForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#vehicleTypeEditForm").on("submit", function(e) {

            showLoading();
            e.preventDefault();

            let formData = new FormData(this);
            let vehicleTypeId = $("#vehicle_type_id").val();

            $.ajax({
                url: "{{ route('vehicle-type.update', ':id') }}".replace(':id', vehicleTypeId),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
