...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-header align-items-start"
        ...
        <div>
            <h5 class="modal-title mb-1" id="productTypeEditModalLabel"
    ...
    <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
        <form id="productTypeEditForm" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter product type name" value="{{ $data->name }}"
                            style="border:1px solid #dfe2e8; border-radius:8px; padding:11px 14px; font-size:14px;">
            ...
            <input type="hidden" value="{{ $data->id }}" id="product_type_id">
        </form>
    </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="productTypeEditForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#productTypeEditForm").on("submit", function(e) {

            showLoading();
            e.preventDefault(); // Prevent default form submission

            let formData = new FormData(this);
            let productTypeId = $("#product_type_id").val();

            $.ajax({
                url: "{{ route('product-type.update', ':id') }}".replace(':id', productTypeId),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
