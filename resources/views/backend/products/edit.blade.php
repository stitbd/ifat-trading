                    ...
                    <form id="productEditForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="product_type_id" id="edit_product_type_id">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#edit_categories_id").on("change", function() {
                ...
                $("#edit_sub_categories_id").html('<option value="">Select Sub Category</option>');
                $("#edit_product_type_id").html('<option value="">Select Product Type</option>');
                $("#edit_product_size_id").html('<option value="">Select Product Size</option>');
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(i, item) {
                            $("#edit_sub_categories_id").append($("<option>", {
                                value: item.id,
                                text: item.name
                            }));
                        });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(i, item) {
                            $("#edit_product_type_id").append($("<option>", {
                                value: item.id,
                                text: item.name
                            }));
                        });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data, function(i, item) {
                            $("#edit_product_size_id").append($("<option>", {
                                value: item.id,
                                text: item.name
                            }));
                        });
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            Swal.fire({
                                icon: "error",
                                title: xhr.status === 403 ? "Access Denied" : (xhr
