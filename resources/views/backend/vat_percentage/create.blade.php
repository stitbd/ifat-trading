        ...
        <div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
            ...
            <div class="modal-header align-items-start"
                ...
                <div>
                    <h5 class="modal-title mb-1" style="color:#1e1e2d; font-weight:700; font-size:18px;">
                        <i class="bi bi-percent me-2" style="color:#4361ee;"></i>
                        Create VAT Percentage
                    </h5>
                    <p class="mb-0" style="color:#8a8a9a; font-size:13px;">
                        Add a new VAT percentage to your catalog
                    </p>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="number" step="0.01" min="0" max="100" class="form-control"
                                    name="value" placeholder="Enter VAT value e.g. 15"
                                    style="border:1px solid #dfe2e8; border-radius:8px; padding:11px 14px; font-size:14px;">
            ...
            <div class="modal-footer d-flex justify-content-between align-items-center"
                ...
                <div>
                    ...
                    <button type="submit" form="vatPercentageCreateForm" class="btn submit-btn"
