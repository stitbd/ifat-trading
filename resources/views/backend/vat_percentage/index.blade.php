...
@include('backend.vat_percentage.create')
...
<script>
    ...
    $(document).on('click', '.edit', function() {
        ...
        $.ajax({
            url: '/vat-percentage/edit/' + dataId,
            type: 'GET',
            success: function(response) {
                $('#modalShow').html(response);
                $('#vatPercentageEditModal').modal('show');
            }
        });
    });
...
<script>
    $(document).on('click', '.status-toggle', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    $('#vatPercentageTable').DataTable().ajax.reload(null, false);
