...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-header align-items-start"
        ...
        <div>
            <h5 class="modal-title mb-1" id="vatPercentageEditModalLabel"
            ...
            <p class="mb-0" style="color:#8a8a9a; font-size:13px;">
                Update the details for this VAT percentage
            </p>
        </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="vatPercentageEditForm" class="btn submit-btn"
