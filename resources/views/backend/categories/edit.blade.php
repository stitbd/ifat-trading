...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-header align-items-start"
        ...
        <div>
            <h5 class="modal-title mb-1" id="categoryEditModalLabel"
    ...
    <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
        <form id="categoryEditForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter category name" maxlength="100" value="{{ $data->name }}"
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        @if ($data->image)
                            <div class="mt-2">
                                <img src="{{ asset('categories/image/' . $data->image) }}" width="90" height="90"
            ...
            <input type="hidden" value="{{ $data->id }}" id="category_id">
        </form>
    </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="categoryEditForm" class="btn submit-btn"
