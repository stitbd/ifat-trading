...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            ...
            <p class="mb-0 text-muted" style="font-size:13px;">Add a new user account</p>
        </div>
    ...
    <div class="card" style="border-radius:12px; border:none;">
        <div class="card-body" style="padding:24px; background-color:#fbfbfd; border-radius:12px;">
            <form id="userCreateForm" method="POST" enctype="multipart/form-data" action="{{ route('user.store') }}">
                @csrf
                                ...
                                <div class="form-check form-switch mb-2 pb-2">
                                    @forelse ($wings as $wing)
                                        <div class="wing-item form-check form-switch mb-2">
                                            <input class="form-check-input wing-switch" type="checkbox"
                                                role="switch" name="wing[]" value="{{ $wing->id }}"
                                                id="wing_{{ $wing->id }}"
                                                style="width:2.5em; height:1.3em; cursor:pointer;">
