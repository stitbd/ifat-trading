...
<div class="modal-content" style="border-radius: 12px; border: none; overflow: hidden;">
    ...
    <div class="modal-header align-items-start"
        ...
        <div>
            <h5 class="modal-title mb-1" id="manufacturerEditModalLabel"
    ...
    <div class="modal-body" style="padding: 24px; background-color: #fbfbfd;">
        <form id="manufacturerEditForm" method="POST">
            @csrf
            @method('put')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="Enter manufacturer name" value="{{ $data->name }}"
            ...
            <input type="hidden" value="{{ $data->id }}" id="manufacturer_id">
        </form>
    </div>
    ...
    <div class="modal-footer d-flex justify-content-between align-items-center"
        ...
        <div>
            ...
            <button type="submit" form="manufacturerEditForm" class="btn submit-btn"
...
<script>
    $(document).ready(function() {
        $("#manufacturerEditForm").on("submit", function(e) {

            showLoading();
            e.preventDefault();

            let formData = new FormData(this);
            let manufacturerId = $("#manufacturer_id").val();

            $.ajax({
                url: "{{ route('manufacturer.update', ':id') }}".replace(':id', manufacturerId),
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        window.location.href =
                            "{{ route('manufacturer.index') }}?added-successfully=" +
